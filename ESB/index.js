...
app.post('/order_restaurant', (req, res) => {    
    ...
    axios.post('http://172.10.10.12:3001/receive_order', {
        order: 'pizza'      
      })
...
app.get('/state_restaurant', (req, res) => {    
    ...
    axios.get('http://172.10.10.12:3001/report_status?order=order_1234', {
...
app.get('/state_dealer', (req, res) => {    
    ...
    axios.get('http://172.10.10.13:3002/report_status', {
        params: {
...
app.post('/recive_order_dealer', (req, res) => {    
    ...
    axios.get('http://172.10.10.13:3002/receive_order', {
        params: {
